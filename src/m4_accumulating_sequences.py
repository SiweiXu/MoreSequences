...
def run_test_make_simple_string():
    ...
    actual = make_simple_string(2, 7)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 2:
    expected = '9-10-11-'
    actual = make_simple_string(9, 11)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 3:
    expected = '15-16-17-18-'
    actual = make_simple_string(15, 18)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 1:
    expected = '2-3-4-5-6-7'
    actual = make_less_simple_string(2, 7)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 2:
    expected = '9-10-11'
    actual = make_less_simple_string(9, 11)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 3:
    expected = '15'
    actual = make_less_simple_string(15, 15)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        point1 = rg.Point(x - r, y - r)
        point2 = rg.Point(x + r, y + r)
